...
class SDK(threading.Thread):
    ...
    def pushTemp(self, data):
        self.client.publish("IN/DEVICE/"+self.key.split("-")[0]+"/"+self.key.split("-")[1]+"/"+self.key.split("-")[2]+"/TEMP/MIN", str(data))
...
if __name__=="__main__":
    sdk= SDK("localhost",1883,"1-1532429649996-1535166306031",on_message,True)
    sdk.start()
    #数据上传
    while 1:
        sdk.pushTemp(32)
