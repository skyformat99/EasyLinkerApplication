...
public class ALiSMSSender {
    ...
    public static void main(String[] args) {
        try {
            ALiSMSSender smsUtils = new ALiSMSSender();
            String telphoneString = "18059150204";
    ...
    public SendSmsResponse sendSms(String telphone) throws ClientException {
        ...
        //短信签名
        request.setSignName("爱卓网络科技");
        //短信模板ID
        request.setTemplateCode("SMS_14235739");
        //验证码
        ALiSMSSender sms = new ALiSMSSender();
        sms.setCode();
